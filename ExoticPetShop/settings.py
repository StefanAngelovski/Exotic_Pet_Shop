"""
Django settings for ExoticPetShop project.
...
CSRF_TRUSTED_ORIGINS = ['https://petshop.42.mk', 'https://petshop.physdev.site']
ALLOWED_HOSTS = ['*']
...
ROOT_URLCONF = 'ExoticPetShop.urls'
...
WSGI_APPLICATION = 'ExoticPetShop.wsgi.application'
